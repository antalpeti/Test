...
public final class Galaxy {
  ...
  /**
   * This is the only method which changes the state of a Galaxy object. If this method were
   * removed, then a copy constructor would not be provided either, since immutable objects do not
